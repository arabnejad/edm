"""Build the available actions for one container."""
...
def _get_action_menu_label(action: ContainerAction) -> str:
...
def _get_action_explanation(action: ContainerAction) -> str:
